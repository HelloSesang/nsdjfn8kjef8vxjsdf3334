(() => {
    ...
    n.n = t => {
        ...
        var c = "BM-login-id",
            ...
            h = "".concat("BM-browser-agent", "-").concat("1.0.15"),
            p = "developer-tools",
            d = "selenium",
            v = "";
                    ...
                    if (i) {
                        ...
                        var a = function(t, e, n) {
                                var r = new URLSearchParams({
                                    ...
                                    agentTag: h,
                                    redirectUrl: encodeURIComponent(O())
                                });
                                if (5 === n.blockType) {
                                    var o, i;
        ...
        function C(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                ...
                o = k(t) ? decodeURIComponent(k(t)) : null,
                i = null;
        ...
        function U(t) {
            var e, n, r = C(u, !1, t);
            return (!r || r.length > 21) && (e = (new Date).getTime().toString(36), n = (Math.random().toString(36).substring(2) + Math.random().toString(36).substring(2)).substring(0, 12), r = "".concat(e, "-").concat(n), I(u, r, !1, t)), r
        }
        ...
        function M() {
            ...
            var S = Object.getPrototypeOf,
                O = S && S(S(I([])));
            O && O !== n && r.call(O, a) && (m = O);
            var k = w.prototype = b.prototype = Object.create(m);
            ...
            return g.prototype = w, o(k, "constructor", {
                value: w,
                configurable: !0
            }), o(w, "constructor", {
                value: g,
            ...
            }, x(k), l(k, u, "Generator"), l(k, a, (function() {
                return this
        ...
        var ht = function() {
            function t(e) {
                ...
                }(this, t), st(this, "stopDevTools", !1), this.config = e, this.init()
            }
            return e = t, r = [{
                key: "getInstance",
                value: function(e) {
                ...
                value: function() {
                    var e, n, r = this;
                    U(this.config), this.config.detectDevTools && (e = this.config, n = function(t) {
                        t !== v && q(r.config, {
                            devTool: t
                        }, void 0, (function(t) {
                            var e = t.whitelistCodes || [];
                            r.stopDevTools = e.includes(11), r.stopDevTools && window.devtoolsDetector && (window.devtoolsDetector.removeListener(), window.devtoolsDetector.stop(), V = !1)
                        }))
                    }, e.detectDevTools && (window.devtoolsDetector || (window.devtoolsDetector = z()), navigator.webdriver && (H = d), V || (z().addListener((function(t, e) {
